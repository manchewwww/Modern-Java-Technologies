...
public class RentalService {
    ...
    public double returnVehicle(Vehicle vehicle, LocalDateTime endOfRent) throws InvalidRentingPeriodException {
        if(endOfRent == null) {
            throw new IllegalArgumentException("End time must be different from null!");
        }
        vehicle.returnBack(endOfRent);
        return vehicle.calculateRentalPrice(vehicle.getStartRentTime(), endOfRent);
    }

    public static void main(String[] args) throws VehicleNotRentedException, InvalidRentingPeriodException, VehicleAlreadyRentedException {
