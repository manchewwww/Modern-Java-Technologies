...
public record Crypto(@SerializedName(ASSET_ID) String assetId,
    ...
    public static Crypto of(String assetId, double priceUsd, int typeIsCrypto, double quantity) {
        return new Crypto(assetId, priceUsd, typeIsCrypto, quantity);
    }
